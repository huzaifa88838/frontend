    ...
    function AttachGUIControls() 
    {
        ...
        else 
        {
            ...
            video.addEventListener('mousemove', function() 
            {
                videoControls.style.display = "block";
                clearTimeout(timeout);
                timeout = setTimeout(function() { videoControls.style.display = "none"; volSlider.style.display = "none"; }, 3000);
            });
        }
        ...
        volume.addEventListener('click', function (e) 
        {
            ...
            if (volSlider.style.display == 'none') 
            {
                ...
                {
                    volSlider.style.left = this.offsetLeft - 43 + 'px';
                    volSlider.style.top = this.offsetTop + 197 + 'px';
                }
